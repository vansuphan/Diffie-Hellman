$(document).ready(() => {
    ...
    socket.on("send-public-key-to-client", (recivePublicKey) => {
        ...
        socket.emit("send-server-two", publicKeyM2);
    ...
    //socket.emit("send-public-key-to-server-two", publicKeyM2);
        //      --- Recive Public Key Client 2 ---
        socket.on("send-public-key-to-client-two", (publicKeyClient2) => {
            ...
            let serectKeyClient2 = Math.pow(publicKeyClient2, privateKeyClient2);
            // ---- Render Serect Key ---- 
